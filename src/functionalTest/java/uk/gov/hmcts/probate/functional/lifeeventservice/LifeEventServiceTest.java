...
public class LifeEventServiceTest extends IntegrationTestBase {
    ...
    @Test
    public void shouldAddDeathRecordWhenManualUpdate() throws JsonProcessingException {
        final String jsonFromFile = utils.getJsonFromFile("lifeEvent/manualUpdate.json");
        ObjectMapper objectMapper = new ObjectMapper();
        ...
        final CallbackResponse callbackResponse = RestAssured.given()
            ...
            .headers(utils.getHeadersWithUserId())
            .body(callbackRequest)
            .when().post("/lifeevent/manualUpdate")
            .then()
            .statusCode(200)
            .extract()
            .as(CallbackResponse.class);
    ...
    @Test
    public void shouldReturnErrorManualUpdate() throws JsonProcessingException {
        final String jsonFromFile = utils.getJsonFromFile("lifeEvent/manualUpdateNonExistent.json");
        ObjectMapper objectMapper = new ObjectMapper();
        objectMapper.findAndRegisterModules();
        final CallbackRequest callbackRequest = objectMapper.readValue(jsonFromFile, CallbackRequest.class);
        final CallbackResponse callbackResponse = RestAssured.given()
